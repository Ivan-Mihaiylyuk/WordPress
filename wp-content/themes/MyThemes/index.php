				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 col-md-push-4 animation_1">
							<h3>Фото</h3>
							<div class="person">
								<?php if ( has_post_thumbnail() ) : ?><!--Фото с нажатием на вывод большого фото -->
                        ...
                        <?php endif; ?><!--Фото с нажатием на вывод большого фото -->
                     </div>
                </div>
						...
						while (have_posts() ) : the_post(); ?>
							<h3><?php the_title(); ?></h3>
							<h2 class="persoal_header"><?php echo get_bloginfo('name'); ?></h2>
							<?php the_content(); ?>
							<? endwhile; endif; wp_reset_query(); ?>
								<div class="social_wrap">
									<ul>
						               ...
						               while (have_posts() ) : the_post(); ?>
										...
										<li><a href="<?php echo get_post_meta($post->ID, 'soc_url', true); ?>" target="blank" title="<?php the_title_attribute(); ?>"><i class="fa <?php echo get_post_meta($post->ID, 'fonts_awesome', true); ?>"></i></a></li>
			...
			<div class="section_content">
				<div class="container">
					...
					<ul>
						...
						<li class="filter" data-filter=".sites">Строительство</li>
						<li class="filter" data-filter=".identy">Интерьер</li>
						<li class="filter" data-filter=".logos">Туризм</li>
					</ul>
				</div>
